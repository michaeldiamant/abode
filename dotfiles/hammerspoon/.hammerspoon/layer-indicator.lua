-- Thanks to https://balatero.com/writings/qmk/add-visual-layer-indicator-for-qmk-to-mac-os/
...
function LayerIndicator:show()
  if not (self.layer.name == "qwerty") then
    self.canvas:show()
  else
    self.canvas:hide()
  end
  ...
  -- https://github.com/Hammerspoon/hammerspoon/blob/master/extensions/canvas/libcanvas.m#L3816
  self.canvas:level("modalPanel")
end
